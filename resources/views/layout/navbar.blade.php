      ...
      <div class="col-3 d-flex justify-content-end align-items-center p-0 m-0 navbar-right-layer" style="padding-right:0 !important;">
        <div class="d-flex gap-2 align-items-center" style="margin-right: 10px;">
          ...
          <div class="icon-wrapper position-relative" id="notifications-icon">
            ...
            <span id="notification-badge" class="nav-alert-badge" style="display:none;" aria-label="إشعارات غير مقروءة">0</span>
          ...
          <div class="icon-wrapper position-relative" id="chat-icon">
            ...
            <span id="message-badge" class="nav-alert-badge" style="display:none;" aria-label="رسائل غير مقروءة">0</span>
